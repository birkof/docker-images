...
# Clear the screen
alias c='clear;echo "Current working directory:";pwd'
...
# Disk usage
alias lh='ls -lh'
alias file-space-usage='du --max-depth=1 -h'
alias file-space-usage-sort='du -sm * | sort -n | tail -n 20'

# TCP/utils
alias ip="ipconfig getifaddr en0"
alias find-port='lsof -iTCP -sTCP:LISTEN | grep' #findPort amqp

# Kernel
alias kernel-version='uname -r'
alias kernel-bit='uname -m'
...
alias my_openports='lsof -iTCP -sTCP:LISTEN -P'
